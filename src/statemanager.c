...
/* Inactivity shutdown, in milliseconds. autoofftimer applies while connected,
 * autoFilterOffTimer while advertising; 0 means "use the built-in default". */
rev_timer_t timer = {
    .autoofftimer = 600000,      /* 10 minutes connected */
    .autoFilterOffTimer = 300000 /* 5 minutes advertising */
};
